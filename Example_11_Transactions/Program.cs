...
namespace MongoDBTransaction
{
    public static class Program
    {
        ...
        const string MongoDBConnectionString = "mongodb+srv://tomkayuriy:fiction@clustertomka.ujvkntv.mongodb.net/test";
        ...
        private static async Task<bool> UpdateProductsAsync()
        {
            ...
            using (var session = await client.StartSessionAsync())
            {
                ...
                try
                {
                    ...
                    {
                        Console.WriteLine(
                                  System.String.Format("Product Name: {0}\tPrice: {1:0.00}",
