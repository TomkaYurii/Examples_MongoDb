...
public class ReplaceOneAsync
{
    ...
    private const string MongoConnectionString = "mongodb+srv://tomkayuriy:fiction@clustertomka.ujvkntv.mongodb.net/test";
    ...
    private static async Task<ReplaceOneResult> ReplaceOneRestaurant()
    {
        ...
        Restaurant newPizzaRestaurant = new()
        {
            ...
            Name = "Mongo's Pizza",
            Cuisine = "Pizza",
            Address = BsonSerializer.Deserialize<Address>(new BsonDocument
            {
                {"street", "Pizza St"},
                {"zipcode", "10003"}
            }),
